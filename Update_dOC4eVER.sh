...
#test ok
 ...
 tput setaf 6 ;tput cuf 7; tput bold ;read -p "Update dOC4eVER_V04 (Y/N)? " -n 1 -r; tput sgr0;
 echo ""
 echo ""
 echo ""
...
case "$REPLY" in 
 ...
 echo ""
    ...
    wget https://github.com/dOC4eVER/dOC4eVER/releases/download/start/update.zip -O /tmp/update.zip -o /dev/null

    wget https://github.com/dOC4eVER/dOC4eVER/raw/master/start_services.sh -O /tmp/start_services.sh -o /dev/null
    #! clear
 echo ""
 echo ""
