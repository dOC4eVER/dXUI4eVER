...
wget -q -O /tmp/xtreamcodes.tar.gz https://github.com/dOC4eVER/dXUI4eVER/releases/download/start/sub_xui_"$OSNAME"_"$VER".tar.gz
...
wget -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb https://github.com/dOC4eVER/dXUI4eVER/releases/download/start/GeoLite2.mmdb
...
wget -O /home/xtreamcodes/iptv_xtream_codes/pytools/config.py https://github.com/dOC4eVER/dXUI4eVER/releases/download/start/config.py
wget -O /home/xtreamcodes/iptv_xtream_codes/pytools/config_p3.py https://github.com/dOC4eVER/dXUI4eVER/releases/download/start/config_p3.py
