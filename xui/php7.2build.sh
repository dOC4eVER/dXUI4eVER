...
logfile=$(date +%Y-%m-%d_%H.%M.%S_php7.2build.log)
touch "$logfile"
exec > >(tee "$logfile")
exec 2>&1
echo "php7.2build.sh"	
...
wget --no-check-certificate -qO- https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/depbuild.sh | bash -s
wget --no-check-certificate -qO- https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/build-pbuilder-and-mock-install.sh | bash -s
ubunbuild () {
cd /root
mkdir -p /root/deb/
wget -O /root/Dockerfile_Ubuntu-$1 https://github.com/dOC4eVER/dXUI4eVER/raw/master/Dockerfile/Dockerfile_Ubuntu-$1
wget -O /root/Ubuntu-$1.sh https://github.com/dOC4eVER/dXUI4eVER/raw/master/Dockerfile/Ubuntu-$1.sh
bash Ubuntu-$1.sh
...
cd /root
mkdir -p /root/deb/
wget -O /root/Dockerfile_debian-$1 https://github.com/dOC4eVER/dXUI4eVER/raw/master/Dockerfile/Dockerfile_debian-$1
wget -O /root/debian-$1.sh https://github.com/dOC4eVER/dXUI4eVER/raw/master/Dockerfile/debian-$1.sh
...
ubunbuild 18.04 \https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/package/python3.10/debian/build.sh \python3.10-build-Ubuntu-18.04.tar
ubunbuild 20.04 \https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/package/python3.10/debian/build.sh \python3.10-build-Ubuntu-20.04.tar
debbuild 11 \https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/package/python3.10/debian/build.sh \python3.10-build-debian-11.tar
debbuild 12 \https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/package/python3.10/debian/build.sh \python3.10-build-debian-12.tar
exit
...
if  [[ "$OS" = "Ubuntu" || "$OS" = "debian" ]] ; then
	...
	--with-openssl=/home/xtreamcodes/iptv_xtream_codes/phpbuild/openssl-OpenSSL_1_1_1w --with-ld-opt='$(dpkg-buildflags --get LDFLAGS)' --with-cc-opt='$(dpkg-buildflags --get CFLAGS)'
	make -j$(nproc --all)
	...
	cd /home/xtreamcodes/iptv_xtream_codes/phpbuild/
	rm -rf /home/xtreamcodes/iptv_xtream_codes/phpbuild/OpenSSL_1_1_1w.tar.gz
	...
	rm -f $(rpm --eval %{_specdir})/xtreamcodes-nginx.spec
 	wget -O $(rpm --eval %{_specdir})/xtreamcodes-nginx.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/nginx/xtreamcodes-nginx.spec
	...
	wget -O $(rpm --eval %{_specdir})/xtreamcodes-nginx-rtmp.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/nginx_rtmp/xtreamcodes-nginx-rtmp.spec
	...
	wget -O $(rpm --eval %{_specdir})/xtreamcodes-php.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/php/xtreamcodes-php.spec
	...
	wget -O $(rpm --eval %{_specdir})/xtreamcodes-php-mcrypt.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/php/xtreamcodes-php-mcrypt.spec
	...
	rm -f $(rpm --eval %{_specdir})/xtreamcodes-php-geoip.spec
 	wget -O $(rpm --eval %{_specdir})/xtreamcodes-php-geoip.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/php/xtreamcodes-php-geoip.spec
	...
	rm -f $(rpm --eval %{_specdir})/xtreamcodes-php-igbinary.spec
 	wget -O $(rpm --eval %{_specdir})/xtreamcodes-php-igbinary.spec https://github.com/dOC4eVER/dXUI4eVER/raw/master/os/package/php/xtreamcodes-php-igbinary.spec
