...
EOF
    ...
    tput setaf 3 ; tput bold ;echo "Updating Aptitude Repos:"; tput sgr0;    
echo ""	
...
if [[ "$OS" = "CentOs" || "$OS" = "CentOS-Stream" || "$OS" = "Fedora" ]]; then
	...
	if [[ "$VER" = "20.04" ||  "$VER" = "22.04"  ]]; then
		...
		mkdir -p /etc/mysql/
 		wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/conf/my.cnf -O /etc/mysql/my.cnf
  		wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/conf/my.cnf -O /etc/my.cnf
   		mkdir -p /etc/init.d/
		...
		chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb >/dev/null
  		rm -rf /home/xtreamcodes/iptv_xtream_codes/admin 2>/dev/null
    		wget -O /tmp/update.zip "https://github.com/dOC4eVER/dXUI4eVER/releases/download/XCodes/update_original.zip" 2>/dev/null
		...
		chown -R xtreamcodes:xtreamcodes /home/xtreamcodes/ >/dev/null
 		...
 		rm -f /etc/init.d/mariadb
		wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/xui/depbuild.sh -O /root/depbuild.sh
