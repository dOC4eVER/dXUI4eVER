...
while getopts ":t:a:p:o:c:r:e:m:s:h:" option; do
    case "${option}" in
        ...
        h)
            echo "help usage"
			echo "curl -L https://github.com/dOC4eVER/dXUI4eVER/raw/master/install.sh | sudo bash -s -- -a adminusername -t timezone -p adminpassord -o adminaccesport -c clientaccesport -r apacheport -e email -m mysqlpassword -s yes"
			...
			echo "full exemple"
			echo "curl -L https://github.com/dOC4eVER/dXUI4eVER/raw/master/install.sh | bash -s -- -a admin -t Europe/Paris -p admin -o 25500 -c 80 -r 8080 -e admin@example.com -m mysqlpassword -s yes"
...
wget -qO- https://github.com/dOC4eVER/dXUI4eVER/raw/master/ubuntu/depbuild.sh | bash
...
wget -q -O /tmp/xtreamcodes.tar.gz https://github.com/dOC4eVER/dXUI4eVER/releases/download/start/main_xui_"$OSNAME"_"$VER".tar.gz
...
modifyNginx()
END
wget -qO install.sql https://github.com/dOC4eVER/dXUI4eVER/raw/master/update_reg_users.py
...
echo " "
echo " "
wget -q -O /tmp/update.zip https://github.com/dOC4eVER/dXUI4eVER/releases/download/XCodes/update.zip
...
rm /tmp/update.zip
rm -rf /tmp/update
      PACKAGE_INSTALLER="apt install -y jq"
xcversion=01
...
chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb
cd /home/xtreamcodes/iptv_xtream_codes/ ; chattr -i -a GeoLite2.mmdb; chmod ugo+w GeoLite2.mmdb;cd 
/home/xtreamcodes/iptv_xtream_codes/permissions.sh
wget -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb https://github.com/dOC4eVER/dXUI4eVER/releases/download/XCodes/GeoLite2.mmdb
geoliteversion=$(wget -qO- https://github.com/dOC4eVER/dXUI4eVER/releases/download/XCodes/Geolite2_status.json | jq -r ".version")
...
#wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/balancer.php -O /home/xtreamcodes/iptv_xtream_codes/crons/balancer.php
#wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/balancer.sh -O /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.sh
#chmod +x /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.sh
rm -f /home/xtreamcodes/iptv_xtream_codes/start_services.sh
wget https://github.com/dOC4eVER/dXUI4eVER/raw/master/start_services.sh -O /home/xtreamcodes/iptv_xtream_codes/start_services.sh
chattr +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb
chmod +x /home/xtreamcodes/iptv_xtream_codes/start_services.sh
if [[ "$OS" = "CentOs" || "$OS" = "Fedora" || "$OS" = "Centos Stream" ]]; then
echo " "
...
echo "done"
echo " +-------------------------------------------------------------------+ "
echo " │[R]        Old CK41 to dOC4eVER v03 Installed successfully         │ "
echo " +-------------------------------------------------------------------+ "
